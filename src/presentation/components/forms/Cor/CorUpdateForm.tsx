...
import { useCorUpdateFormController } from "./CorUpdateForm.controller";
 ...
 */
export const CorUpdateForm = (props: { onSubmit?: () => void,pid:String }) => {
    const { formatMessage } = useIntl();
    const { state, actions, computed } = useCorUpdateFormController(props.pid,props.onSubmit); // Use the address form controller
