...
import { SolicitantiDTO, UserDTO } from "@infrastructure/apis/client";
...
export const SolicitantiTable = () => {
    ...
    const { handleChangePage, handleChangePageSize, pagedData, isError, isLoading, tryReload, labelDisplay } = useSolicitantiTableController(); // Use the controller hook.
