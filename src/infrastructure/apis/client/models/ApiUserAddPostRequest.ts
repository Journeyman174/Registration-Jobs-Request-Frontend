...
export interface ApiUserAddPostRequest {
     ...
     * @memberof ApiUserAddPostRequest
     */
    role: ApiUserAddPostRequestRoleEnum;
}
 ...
 * @export
 */
export const ApiUserAddPostRequestRoleEnum = {
    Admin: 'Admin',
    Personnel: 'Personnel',
    Solicitant: 'Solicitant',
    Client: 'Client'
} as const;
export type ApiUserAddPostRequestRoleEnum = typeof ApiUserAddPostRequestRoleEnum[keyof typeof ApiUserAddPostRequestRoleEnum];
